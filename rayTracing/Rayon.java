...
public class Rayon {
	 ...
	 */
	public Rayon(Point origine, Point impact, Pixel pixelPere, Rayon rayonPere, Couleur couleur, Objet3D objetOrigine) {
		...
		this.objetOrigine = objetOrigine;
	 ...
	 */
	public Rayon(Vecteur direction, Point origine, Rayon rayonPere, double pCouleur, double pEnergie, Objet3D objetOrigine) {
	...
	public void setCouleur(int r, int v, int b) {
		// TODO assert int ? 
		this.couleur = new Couleur( new Color(r,v,b));
	}
	...
	/** Obtenir l'objet dont est issu le rayon, 
	 * renvoie null si le rayon n'est pas issu d'un Objet3D
	 * @return Objet3D objetOrigine l'objet dont est issu le rayon
	 */
	public Objet3D getObjetOrigine() {
		return this.objetOrigine;
	}
	
	/** Obtenir l'objet dont est issu le rayon.
	 * @param objetOrigine le nouvel objet d'origine
	 */
	public void setObjetOrigine(Objet3D objetOrigine) {
		this.objetOrigine = objetOrigine;
	}
