...
public class Scene implements Serializable {
	...
	/** Obtenir l'indice de refraction de la scene
	 * @return indice de refraction de la scene
	 */
	public double getIndiceRefraction() {
		return Scene.indiceRefraction;
	}
	...
	/** Modifier la couleur d'ambiance de la scène.
	 * @param couleur la nouvelle couleur de la scène
	 */
	public void setAmbiante(Couleur couleur) {
		this.ambiante = couleur;
	}
